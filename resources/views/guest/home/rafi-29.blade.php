        ...
        <div class=" w-full max-w-[1080px] mx-auto">
            <div class=" w-full grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-8">
                ...
                <div class=" w-full col-span-1 md:col-span-3 space-y-4 sm:space-y-8">
                            ...
                            <div class="flex gap-4 items-start">
                                ...
                                <div class="flex flex-col justify-between flex-1">
                                    <a href="{{ route('detail', ['slug' => $item->slug]) }}">
                                        <h3
                                            class="font-semibold text-base md:text-lg text-black hover:text-main line-clamp-2">
                                            {{ $item->judul }}
                                        </h3>
                                    </a>
                    ...
                    <div class="text-center mt-14">
                        <a href="{{ route('article') }}"
                            class="inline-block px-7 py-3 bg-main text-white rounded-full font-semibold hover:opacity-90 transition">
                            Lihat Semua
                        </a>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div
                        class="hidden md:block md:sticky top-24 space-y-4 sm:space-y-6 bg-white p-4 rounded-lg shadow-lg border border-gray-100 transition-all duration-300 transform translate-x-full md:translate-x-0">
