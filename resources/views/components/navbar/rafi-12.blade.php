<div class="sticky top-0 z-40 bg-white shadow-md" x-data="{ open: false, article: false }">
  <div class="max-w-[1080px] mx-auto px-4 md:px-8 py-4 flex justify-between items-center">
    ...
    {{-- Search Desktop --}}
    <button @click="open = true" class="p-2 rounded hover:bg-gray-100">
    ...
    <div
      ...
      <div
        class="bg-white text-black rounded-xl shadow-lg w-full max-w-lg p-4"
        @click.away="open = false">
        <input
          type="text"
          placeholder="Cari Artikel ..."
          class="w-full p-3 rounded-md bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
          x-model="query" />
