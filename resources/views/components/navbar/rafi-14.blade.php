<div class="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-gray-200" x-data="{ open: false }">
  <div class="max-w-[1200px] mx-auto px-4 md:px-8 py-5 flex items-center justify-between">
    {{-- Navbar Desktop --}}
    <div class="hidden md:flex items-center space-x-8">
      ...
      <div x-data="{ openDropdown: false }" class="relative">
        <button @click="openDropdown = !openDropdown" class="flex items-center gap-1 text-gray-700 hover:text-main font-semibold transition duration-200">
          Artikel
        ...
        <div x-show="openDropdown" @click.away="openDropdown = false"
          class="absolute left-0 mt-3 bg-white shadow-lg rounded-lg w-[400px] overflow-hidden"
          x-transition>

          <div class="flex">
            <div class="w-3/5 p-3 space-y-1">
              <a href="{{ route('article') }}"
                class="flex items-center gap-2 px-3 py-2 text-gray-700 hover:bg-main/10 rounded transition duration-200">
