<div x-data="{ open: false, article: false, openSearch: false }" class="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-gray-200">
        ...
        <div class="hidden md:flex items-center space-x-6 font-semibold text-lg">
            ...
            <div x-data="{ openDropdown: false }" class="relative">
                <button @click="openDropdown = !openDropdown"
                    class="flex items-center gap-1 px-2 py-1 {{ request()->routeIs('article*', 'category*', 'tag*', 'detail') ? 'text-main font-semibold' : 'text-gray-700 hover:text-main' }}">
                    Artikel
    ...
    <div x-show="openSearch" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="max-w-[800px] mx-auto px-4 py-8 relative flex items-center gap-6">
            {{-- Form Search --}}
            <form action="{{ route('article') }}" method="get" class="flex-1 relative">
            ...
            {{-- Tombol Close sejajar --}}
            <button @click="openSearch = false"
                class="shrink-0 text-gray-600 hover:text-main transition-transform transform hover:rotate-90">
        ...
        {{-- Tag Populer --}}
        <div class="max-w-[800px] mx-auto px-4 mt-5 flex flex-wrap gap-2 pb-4">
