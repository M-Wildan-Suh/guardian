<div class="px-0 sm:px-6 lg:px-8 py-4 sm:py-6">
  <div class="swiper mySwiper w-full max-w-[1080px] mx-auto rounded-lg sm:rounded-lg overflow-hidden shadow-md">
    <div class="swiper-wrapper">
      @foreach (array_slice($trend, 0, 4) as $item)
      <div class="swiper-slide relative w-full h-[240px] sm:max-w-full sm:h-[300px] md:h-[400px]">
        {{-- Banner --}}
