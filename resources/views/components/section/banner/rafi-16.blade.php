<div class="w-full flex justify-center mt-2 sm:mt-4 px-2 sm:px-4">
    <div class="w-full max-w-[1080px]">
        <div class="swiper relative w-full h-[260px] sm:h-[400px] lg:h-[500px] rounded-xl sm:rounded-3xl overflow-hidden">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide w-full h-full overflow-hidden relative">
                    ...
                    <div class="absolute bottom-3 sm:bottom-6 left-3 sm:left-6 right-3 sm:right-6 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 shadow-xl">
                        <div class="space-y-2 sm:space-y-4">
                            ...
                            <a href="{{route('detail', ['slug' => $item->slug])}}" class="block">
                                <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-white line-clamp-1 hover:text-main transition-colors">
                                    {{$item->judul}}
                                </h2>
                            </a>
