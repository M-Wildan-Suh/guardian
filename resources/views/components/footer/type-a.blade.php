...
<div class=" w-full">
    {{ $additional ?? '' }}
    <div id="kontak" class=" w-full bg-main pt-10 pb-6 divide-y-2 divide-white space-y-6">
            ...
            <div class=" w-full max-w-[1080px] mx-auto grid grid-cols-3 gap-4 sm:gap-6 text-white">
                    ...
                    <div class=" space-y-4">
                        ...
                        <div class=" flex gap-2">
                            <a href="https://www.instagram.com/jasawebsite.biz/" target="__blank">
                                <div class=" bg-white text-main w-8 aspect-square rounded-lg overflow-hidden p-1 hover:scale-105 duration-300">
                ...
                <div class=" space-y-4">
                    ...
                    <div class=" text-white flex flex-col gap-2 text-sm pl-4">
                        ...
                        <a href="{{ request()->routeIs('detail') ? route('home') : '' }}#kontak" class=" list-item hover:underline duration-300">Kontak</a>
                    </div>
                </div>
