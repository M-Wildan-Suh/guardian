                ...
                <div class=" col-span-3 md:col-span-1 space-y-6">
                    <div class=" space-y-2">
                        <a href="{{ route('home') }}" class="">
                            <div
                                class=" w-full h-10 sm:h-12 text-3xl sm:text-4xl font-bold text-white flex items-start overflow-hidden">
                    ...
                    <div class=" space-y-4">
                        ...
                        <div class=" flex gap-2">
                            <a href="https://www.instagram.com/jasawebsite.biz/" target="__blank">
                                <div
                                    class=" bg-white text-main w-8 aspect-square rounded-lg overflow-hidden p-1 hover:scale-105 duration-300">
